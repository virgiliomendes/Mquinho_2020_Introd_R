  % Script baseado no material disponibilizado pelo pesquisador @arturhgq 
 % para a monitoria da disciplina de inferência causal 2020/1 UFMG.
...
\setcounter{secnumdepth}{0} %Numerar seções e subseções (1 se somente seções)
...
\newcommand{\titulo}[1]{\footnotesize DCP | UFMG \\
                    \huge Planejamento de Aulas - MQuinho 2020 \\
                    \textbf{#1}}

\newcommand{\autor}[2]{\large #1\thanks{Mestrando em Ciência Política; E-mail: #2}}
